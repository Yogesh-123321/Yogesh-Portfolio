// lucide-react removed brand/logo icons (GitHub, LinkedIn, etc.) starting
// in its v1 release, so these two are hand-drawn to match its 24x24,
// stroke-based icon style and keep the same props contract (size, className).
